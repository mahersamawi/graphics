...
function draw() { 
    ...
    // Change from 45 to 65 so the entire plane is in the picture
    mat4.perspective(pMatrix,degToRad(65), gl.viewportWidth / gl.viewportHeight, 0.1, 200.0);
    ...
    // From the original code. just picked the first one
